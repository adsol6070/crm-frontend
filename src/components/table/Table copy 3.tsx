...
const IndeterminateCheckbox = forwardRef<
	HTMLInputElement,
	IndeterminateCheckboxProps & { onChange?: (e: React.ChangeEvent<HTMLInputElement>) => void }
...
type TableProps<TableValues> = {
	...
	tableClass?: string
	theadClass?: string
	onSelectedRowsChange?: (selectedRows: Array<{}>) => void
}
...
const Table = <TableValues extends object = {}>(
						...
						Header: ({ getToggleAllPageRowsSelectedProps }: any) => (
							<div>
								<IndeterminateCheckbox
									...
									onChange={(e) => {
										getToggleAllPageRowsSelectedProps().onChange(e);
										setRowSelectionChanged((prev) => !prev);
									}}
								/>
							</div>
						),
	...
	const { selectedFlatRows } = dataTable

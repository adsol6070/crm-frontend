...
type TableProps<TableValues> = {
	...
	tableClass?: string
	theadClass?: string
	onSelectedRowIdsChange?: (selectedRowIds: Record<string, boolean>) => void
}
...
const Table = <TableValues extends object = {}>(
	...
	const onSelectedRowIdsChange = props['onSelectedRowIdsChange'] || (() => {})
	...
	const { selectedRowIds } = dataTable.state

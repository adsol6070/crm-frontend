...
import { RiDeleteBinLine, RiEyeLine, RiAddLine, RiAlignLeft } from 'react-icons/ri'
			...
			</Card.Body>
			{
				isHighlighted && (
					<div
						...
						<button className="btn btn-light btn-sm d-flex align-items-center justify-content-start" onClick={() => onMoveTask(card)}>
							<LuMoveRight size={14} style={{ marginRight: '4px' }} />
							Move
						</button>
						<button className="btn btn-light btn-sm d-flex align-items-center justify-content-start" onClick={() => onCopyTask(card)}>

...
const fieldOrder = [
  ...
  'scholarships', 'visaExpiryDate', 'visaType', 'previousStudyAbroad', 'previousVisaApplications',
  'leadRating', 'followUpDates', 'referralContact', 'leadSource', 'preferredContactTime', 'communicationMode'
];
                    ...
                    <>
                      ...
                      <Form.Group>
                        ...
                        <Controller
                          name="nationality"
                          control={control}
                          defaultValue={selectNationalityOptions}
                          render={({ field }) => (
                            <Select
                              {...field}
                  ...
                  {step === 3 && (
                    <>
                      <Form.Group>
                        ...
                        />
                        {errors.visaCategory && <p className="text-danger">{errors.visaCategory.message}</p>}
                      </Form.Group>
                      <Form.Group>
                        ...
                        <Controller
                          ...
                          control={control}
                          defaultValue={selectedCountryOfInterest}
                          render={({ field }) => (
                            <Select
                              {...field}
                        ...
                        />
                        {errors.countryOfInterest && <p className="text-danger">{errors.countryOfInterest.message}</p>}
                      </Form.Group>
                      <FormInput

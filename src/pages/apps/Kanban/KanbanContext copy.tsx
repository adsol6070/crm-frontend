...
export const KanbanProvider: React.FC<{ children: ReactNode }> = ({
	...
	const { tasks, loading, createTask, deleteTaskById, updateTaskStatus, updateTaskById, createTaskColumn, taskColumnsData } =
		useTask(boardId)
